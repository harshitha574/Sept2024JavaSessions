...
public class ElementUtil {
	...
	public ElementUtil(WebDriver driver) {
	 ...
	 private void doClick(String locatorType, String locatorValue) {
	...
	private  void doSendKeys(String locatorType , String locatorValue, CharSequence... value) {
		nullCheck(value);
	...
	public  void printDropDownOptionList(By locator) {
		Select select = new Select(getElement(locator));
	...
	public  void doSearch(By searchField,By suggessions,String searchKey,String actualValue ) throws InterruptedException {
		
		doSendKeys(searchField, searchKey);
		Thread.sleep(2000);
	
		List<WebElement> suggList = getElements(suggessions);
...
//******************Actions utils*********************//
	...
	public  void handleFourLebelMenuSubMenuHandling(By level1Menu, By level2Menu, By level3Menu, By level4Menu) throws InterruptedException {
		Actions act = new Actions(driver);
