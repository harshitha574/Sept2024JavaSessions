...
public class LoginPage {
	...
	//page objects should follow Encapsulation ====>all the locators should be declared as private
	...
	@Step("checking forgor pwd link is displayed...")
